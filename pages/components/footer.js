      ...
      <footer className="px-10 mt-24">
          ...
          <div className="mt-6 shrink-0 md:mt-0 md:w-auto md:mx-10">
            <div>
              ...
              <div className="relative">
                <input
                  type="email"
                  className="w-full border-b border-yellow-600 p-4 pr-12 text-4xl bg-transparent text-gray-900"
        ...
        <div className="flex items-center justify-between px-20">
          ...
          <div className="flex -mx-2">
            <a
              href="#"
              className="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500 rounded-full p-4 border"
            >
              <BsFacebook className="text-2xl text-gray-800" />
            </a>
            ...
            <a
              ...
              className="mx-2 text-gray-600 transition-colors duration-300 hover:text-blue-500 rounded-full p-4 border"
            >
              <IoLogoTwitter className="text-2xl text-gray-800" />
            </a>
          </div>
        </div>
      </footer>
      {/* ----Bottom-Footer---- */}
      <div className="mx-auto bg-stone-800 py-5 mt-5">
